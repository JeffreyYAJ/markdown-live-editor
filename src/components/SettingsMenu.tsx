  ...
  return (
    <div
      ...
      className="absolute left-full bottom-0 ml-2 z-50 w-64 rounded-lg shadow-2xl overflow-hidden
                 border border-[var(--color-inactive)]
    ...
    >
      ...
      {/* Header */}
      <div className="px-4 py-3 border-b border-[var(--color-inactive)] flex items-center gap-2">
        <Settings size={14} className="text-[var(--color-neon)]" />
        <span className="font-mono text-xs tracking-widest text-[var(--color-dimmed)] uppercase">
          Settings
        </span>
      </div>
        ...
        {menuItems.map(({ icon: Icon, label }) => (
          <li
            ...
            className="flex items-center gap-3 px-4 py-2.5 cursor-pointer
                       text-sm text-[var(--color-main)] font-sans
                       hover:bg-[var(--color-neon-bg)] hover:text-[var(--color-neon)]
                       transition-colors duration-150"
          >
            <Icon size={15} className="shrink-0 text-[var(--color-dimmed)]" />
            {label}
          </li>
        ))}
      </ul>
      ...
      {/* Divider */}
      <div className="border-t border-[var(--color-inactive)]" />

      {/* Theme section */}
      <div className="px-4 py-3">
        <div className="flex items-center gap-2 mb-3">
          <Palette size={14} className="text-[var(--color-neon)]" />
          <span className="font-mono text-xs tracking-widest text-[var(--color-dimmed)] uppercase">
            Theme
          </span>
        </div>
            ...
            return (
              ...
              >
                ...
                <span
                  ...
                  style={{
                    color: isActive ? t.accent : "var(--color-main)",
